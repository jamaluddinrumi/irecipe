...
/**
 * IniResepDetail Class
 */
class IniResepDetail extends HTMLElement {
  set resep(resep) {
    this._resep = resep;
    this.render();
  }
  ...
  render() {
    ...
    this.className += "col col-sm-12 col-md-6 col-lg-4 mb-4";
    this.className += " ";
    this.className += this._resep.strCategory.toLowerCase();
    this.innerHTML = `
      <div class='card shadow-sm'>
        <div class='card-header py-4'>
          <a class='receipe-link' target='_blank' href='${
            this._resep.strSource
          }'>
        ...
        <div class='card-body'>
          ...
          <a target='_blank' href='${
            this._resep.strSource
          }' class='btn btn-block btn-light rounded-pill shadow-sm source'>Source 
...
customElements.define("ini-resepdetail", IniResepDetail);
